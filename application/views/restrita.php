        ...
        <div class="row">
			<div class="col-lg-offset-5 col-lg-2 text-center">
				<div class="form-group">
                    ...
                    <a class="btn btn-link" href="login/logoff"><i class="fa fa-sign-out"></i></a>
				</div>
			</div>
		</div>
	</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-tittle">Curso</h4>
            </div>
            ...
            <div class="modal-body">
                <form id="form_course" method="POST">
                    ...
                    <div class="form_group">
                        ...
                        <div class="col-lg-10">
                            <input id="course_name" name="course_name" class="form-control" maxlenght="100">
                    ...
                    <div class="form_group">
                        ...
                        <div class="col-lg-10">
                            <img id="course_img_path" src="" style="max-height: 200px; max-widht: 200px"/>
                    ...
                    <div class="form_group">
                        ...
                        <div class="col-lg-10">
                            <input type="number" step="0.1" id="course_duration" name="course_duration" class="form-control" maxlenght="100">
                            <span class="help-block"></span>
                        </div>
                    </div>
...
<div id="modal_member" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">X</button>
                <h4 class="modal-tittle">Membro</h4>
            </div>
            ...
            <div class="modal-body">
                <form id="form_member">
                    ...
                    <div class="form_group">
                        <label class="col-lg-2 control-label">Nome</label>
                        <div class="col-lg-10">
                            <input id="member_name" name="member_name" class="form-control" maxlenght="100">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form_group">
                        ...
                        <div class="col-lg-10">
                            <img id="member_photo_path" src="" style="max-height: 200px; max-widht: 200px"/>
                            <label class="btn btn-block btn-info">
                                <i class="fa fa-upload"></i>&nbsp;&nbsp;Importar foto
...
<div id="modal_user" class="modal fade">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">X</button>
                <h4 class="modal-tittle">Usuário</h4>
            </div>
            ...
            <div class="modal-body">
                <form id="form_user">
                    ...
                    <div class="form_group">
                        ...
                        <div class="col-lg-10">
                            <input id="user_login" name="user_login" class="form-control" maxlenght="30">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form_group">
                        ...
                        <div class="col-lg-10">
                            <input id="user_full_name" name="user_full_name" class="form-control" maxlenght="100">
                            <span class="help-block"></span>
                        </div>
                    </div>
