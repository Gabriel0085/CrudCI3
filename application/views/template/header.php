		...
		<nav class="navbar navbar-default navbar-shrink navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header page-scroll">
					...
					<a class="navbar-brand page-scroll logo" href="#page-top"><img src="<?php echo base_url(); ?>public/images/logoCode.png" style="width: 40px;"></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a class="page-scroll" href="<?php base_url(); ?>#about">Sobre</a>
						</li>
						<li>
							<a class="page-scroll" href="<?php base_url(); ?>#portfolio">Cursos</a>
						</li>
						<li>
							<a class="page-scroll" href="<?php base_url(); ?>#team">Equipe</a>
						</li>
						<li>
							<a class="page-scroll" href="<?php base_url(); ?>#contact">Contato</a>
						</li>
						<li>
