$(function(){
    ...
    $("#form_course").submit(function(){
        $.ajax({
            type: "POST",
            url: BASE_URL + "login/ajax_save_course",
            dataType: "json",
            data: $(this).serialize(),
            beforeSend: function(){
                clearErrors();
    ...
    $("#form_member").submit(function(){
        $.ajax({
            type: "POST",
            url: BASE_URL + "login/ajax_save_member",
            dataType: "json",
            data: $(this).serialize(),
            beforeSend: function(){
                clearErrors();
    ...
    $("#form_user").submit(function(){
        $.ajax({
            type: "POST",
            url: BASE_URL + "login/ajax_save_user",
            dataType: "json",
            data: $(this).serialize(),
            beforeSend: function(){
                clearErrors();
    ...
    $("#btn_your_user").click(function(){
        $.ajax({
            type: "POST",
            url: BASE_URL + "login/ajax_get_user_data",
            dataType: "json",
    ...
    var dt_course = $("#dt_courses").DataTable({
        "serverSide": true,
        "ajax": {
            "url": BASE_URL + "login/ajax_list_course",
            "type": "POST",
        }
    })
})